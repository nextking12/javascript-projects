...
describe("isPalindrome", function (){
    test("should return true for single letter", function(){
        expect(isPalindrome("a")).toBe(true)
    });
    test("should return true for multiple single letters", function(){
        expect(isPalindrome("aaa")).toBe(true)
    });
    test("should return true for longer words", function(){
